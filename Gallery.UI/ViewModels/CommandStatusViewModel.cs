...
namespace Gallery.UI.ViewModels
{
    ...
    public class CommandStatusViewModel : ViewModelBase
    {
        public CommandStatusViewModel(IObservable<bool> isExecuting, IObservable<string> label, IObservable<float?>? progress = null)
        {
        ...
        public CommandStatusViewModel(IObservable<bool> isExecuting, string label, IObservable<float?>? progress = null)
